...
module.exports = (app) => {
  ...
  app.put("/api/admin/product/", passport.authenticate('jwt', {session: false}), productsController.create)
  ...
  app.post("/api/admin/product/:productId/updatePrice", passport.authenticate("jwt", {session: false}), 
